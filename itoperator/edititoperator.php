...
<nav class="navi_menu" id="mySidenav">
  ...
  <a href="../itoperator/edititoperator.php" class="active"><img src="../img/account.png" class="image">&nbsp;&nbsp;UPDATE PROFILE</a>
</nav>
...
<div class="em2" align="left">
    ...
    if (isset($_POST['submit'])) {
            ...
            if(mysqli_query($conn,$sql)){
                ...
                echo "<script>window.location(location:edititoperator.php);</script>";
                die();
            } else{echo "error";}
